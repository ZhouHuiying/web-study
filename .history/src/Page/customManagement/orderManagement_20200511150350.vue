    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="信息列表" name="first">
        ...
        >
          ...
          <el-table-column prop="factory" label="编号" width="120"></el-table-column>
          <el-table-column prop="factory" label="公司名称" width="120"></el-table-column>
          <el-table-column prop="nextContact" label="订单编号" show-overflow-tooltip></el-table-column>
          <el-table-column prop="detail" label="联系人" show-overflow-tooltip></el-table-column>
          <el-table-column prop="recordTime" label="下单日期" show-overflow-tooltip></el-table-column>
          <el-table-column prop="nextContact" label="交单日期" show-overflow-tooltip></el-table-column>
          <el-table-column prop="detail" label="预付款" show-overflow-tooltip></el-table-column>
          <el-table-column prop="recordTime" label="订单金额" show-overflow-tooltip></el-table-column>
          <el-table-column fixed="right" label="订单状态" width="100">
              <el-table-column prop="recordTime" label="业务员" show-overflow-tooltip></el-table-column>
          <el-table-column fixed="right" label="录入时间" width="100">
