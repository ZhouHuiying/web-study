    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="信息列表" name="first">
        ...
        >
          ...
          <el-table-column prop="paymentDate" label="最后更新"></el-table-column>
          <el-table-column prop="paymentType" label="业务员"></el-table-column>
          <el-table-column prop="feeType" label="申请人"></el-table-column>
