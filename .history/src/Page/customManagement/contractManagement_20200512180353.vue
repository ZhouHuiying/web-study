        ...
        >
          ...
          <el-table-column prop="manage" label="管理">
            <template slot-scope="scope">
              <el-button @click="contractLookDetail(scope.row,scope.$index)" type="text" size="small">编辑</el-button>
...
export default {
  ...
  methods: {
    ...
    edit() {
      this.tableData.splice(this.activeIndex, 1, this.dialogForm);
