    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="信息列表" name="first">
        ...
        >
          ...
          <el-table-column prop="submitDate" label="交单日期" show-overflow-tooltip></el-table-column>
          <el-table-column prop="preMoney" label="预付款" show-overflow-tooltip></el-table-column>
          <el-table-column prop="orderAmount" label="订单金额" show-overflow-tooltip></el-table-column>
          <el-table-column fixed="status" label="订单状态" width="100"></el-table-column>
              <el-table-column prop="people" label="业务员" show-overflow-tooltip></el-table-column>
          <el-table-column fixed="inTime" label="录入时间" width="100"></el-table-column>
              <el-table-column fixed="manage" label="管理" width="100">
