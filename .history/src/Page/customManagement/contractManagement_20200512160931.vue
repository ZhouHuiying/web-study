<template>
  <div class="allContent">
    ...
    <el-dialog title="编辑" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
      ...
      <el-form ref="contractTableData" :rules="rules" :model="contractTableData" label-width="80px">
        <el-form-item label="合同名称">
          <el-input v-model="contractTableData.contract"></el-input>
        </el-form-item>

        <el-form-item label="合同分类">
          <el-select v-model="contractTableData.contractType" placeholder>
            <el-option label="1" value="1"></el-option>
            <el-option label="2" value="2"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="合同编号">
          <el-input v-model="contractTableData.contractNumber"></el-input>
        </el-form-item>

        <el-form-item label="起始时间">
          <el-date-picker v-model="contractTableData.startTime" type="date" placeholder="选择日期"></el-date-picker>
        </el-form-item>

        <el-form-item label="到期时间">
          <el-date-picker v-model="contractTableData.endTime" type="date" placeholder="选择日期"></el-date-picker>
        </el-form-item>

        <el-form-item label="已收款">
          <el-input v-model="contractTableData.getMoney"></el-input>
        </el-form-item>

          <el-form-item label="总金额">
          <el-input v-model="contractTableData.allMoney"></el-input>
        </el-form-item>

         <el-form-item label="提供发票">
          <el-select v-model="contractTableData.bill" placeholder>
            <el-option label="1" value="1"></el-option>
            <el-option label="2" value="2"></el-option>
          </el-select>
        </el-form-item>
         ...
         <el-form-item label="是否含税">
          <el-select v-model="contractTableData.type" placeholder>
            <el-option label="1" value="1"></el-option>
            <el-option label="2" value="2"></el-option>
          </el-select>
        </el-form-item>
         ...
         <el-form-item label="详情备注">
          <el-select v-model="contractTableData.detail" placeholder>
            <el-option label="1" value="1"></el-option>
            <el-option label="2" value="2"></el-option>
          </el-select>
        </el-form-item>
