  ...
  <div class="allContent">
      ...
      <el-tab-pane label="信息列表" name="first">
        ...
        >
          ...
          <el-table-column label="编号" width="120">
            <template slot-scope="scope">{{ scope.row.date }}1</template>
          </el-table-column>
          ...
          <el-table-column prop="detail" label="详细内容" show-overflow-tooltip></el-table-column>
          ...
          <el-table-column fixed="right" label="管理" width="100">
            <template slot-scope="scope">
              <el-button @click="documentaryLookDetail(scope.row)" type="text" size="small">查看</el-button>
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="50%" :before-close="handleClose">
      ...
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="跟单类型">
          <el-select v-model="form.region" placeholder="请选择活动区域">
            <el-option label="初步接触" value="shanghai"></el-option>
            <el-option label="待开发" value="beijing"></el-option>
          </el-select>
        </el-form-item>
