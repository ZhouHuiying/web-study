    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="信息列表" name="first">
        ...
        >
          ...
          <el-table-column prop="startTime" label="是否解决"></el-table-column>
          <el-table-column prop="endTime" label="反馈主题"></el-table-column>
          <el-table-column prop="contractType" label="联系人"></el-table-column>
          <el-table-column prop="allMoney" label="反馈日期"></el-table-column>
          <el-table-column prop="getMoney" label="处理"></el-table-column>
          <el-table-column prop="oweMoney" label="欠款"></el-table-column>

          <el-table-column prop="manage" label="管理">
            <template slot-scope="scope">
              <el-button
                @click="contractLookDetail(scope.row)"
                type="text"
                size="small"
              >编辑</el-button>
