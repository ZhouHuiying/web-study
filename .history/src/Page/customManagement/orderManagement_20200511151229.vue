    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="信息列表" name="first">
        ...
        >
          ...
          <el-table-column prop="" label="预付款"></el-table-column>
          <el-table-column prop="orderAmount" label="订单金额"></el-table-column>
          <el-table-column fixed="status" label="订单状态"></el-table-column>
          <el-table-column prop="people" label="业务员"></el-table-column>
          <el-table-column fixed="inTime" label="录入时间"></el-table-column>

          <el-table-column fixed="manage" label="管理">
  ...
  data() {
    return {
      ...
      orderTableData: [
        {
          factory: "浙江联通",
          orderNumber: "2020-4-21",
          contact: "2020-4-21",
        orderDate: "浙江联通",
          submitDate: "2020-4-21",
