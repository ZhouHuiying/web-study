    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="信息列表" name="first">
        ...
        >
          ...
          <el-table-column prop="contract" label="收支日期"></el-table-column>
          <el-table-column prop="isSolve" label="收支类型"></el-table-column>
          <el-table-column prop="subject" label="费用类型"></el-table-column>
          <el-table-column prop="contact" label="总金额"></el-table-column>
          <el-table-column prop="date" label="详情备注"></el-table-column>
          <el-table-column prop="handle" label="业务员"></el-table-column>
