    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="信息列表" name="first">
        ...
        >
          ...
          <el-table-column prop="orderNumber" label="起始时间"></el-table-column>
          <el-table-column prop="contact" label="到期时间"></el-table-column>
          <el-table-column prop="orderDate" label="合同分类"></el-table-column>
          <el-table-column prop="submitDate" label="总金额"></el-table-column>
          <el-table-column prop="preMoney" label="已收款"></el-table-column>
          <el-table-column prop="orderAmount" label="欠款"></el-table-column>
          <el-table-column prop="status" label="提供发票"></el-table-column>
          <el-table-column prop="people" label="是否含税"></el-table-column>
          <el-table-column prop="inTime" label="合同状态"></el-table-column>
          <el-table-column prop="status" label="审核人员"></el-table-column>
          <el-table-column prop="people" label="审核"></el-table-column>
