    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="售后记录" name="sixth">
        <el-table :data="afterSaleTableData" style="width: 100%">
          ...
          <el-table-column prop="feedbackTheme" label="反馈主题"></el-table-column>
          <el-table-column prop="contact" label="联系人"></el-table-column>
          <el-table-column prop="feedbackDate" label="反馈日期"></el-table-column>
          <el-table-column prop="detail" label="详情备注"></el-table-column>
          <el-table-column prop="outcome" label="处理结果"></el-table-column>
          <el-table-column prop="manage" label="管理"></el-table-column>
        </el-table>
      </el-tab-pane>

      <el-tab-pane label="费用记录" name="seventh">
        <el-table :data="afterSaleTableData" style="width: 100%">
      ...
      <el-tab-pane label="客户共享" name="ninth">
        <div class="tabHead">选择共享对象</div>
        ...
        <el-form ref="form" :model="shareForm" label-width="80px">
          ...
          <el-form-item label="总经理室">
            <el-radio-group v-model="shareForm.manager">
              <el-radio label="ych"></el-radio>
              <el-radio label="gm"></el-radio>
              <el-radio label="lml"></el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="财务部"></el-form-item>
          <el-form-item>
      ...
      <el-tab-pane label="操作记录" name="tenth">
        <el-table :data="operationTableData" style="width: 100%">
          <el-table-column prop="date" label="编号" width="180"></el-table-column>
          <el-table-column prop="name" label="数据表" width="180"></el-table-column>
          <el-table-column prop="address" label="行为"></el-table-column>
          <el-table-column prop="date" label="原因" width="180"></el-table-column>
