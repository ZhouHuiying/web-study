    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="合同记录" name="fifth">
        <el-table :data="contractTableData" style="width: 100%">
          <el-table-column prop="orderNumber" label="合同名称"></el-table-column>
          <el-table-column prop="contact" label="合同编号"></el-table-column>
          <el-table-column prop="orderDate" label="起始时间"></el-table-column>
          <el-table-column prop="presentDate" label="到期时间"></el-table-column>
          <el-table-column prop="preMoney" label="合同分类"></el-table-column>
          <el-table-column prop="orderAmount" label="总金额"></el-table-column>
          <el-table-column prop="orderState" label="已收款"></el-table-column>
          <el-table-column prop="detail" label="欠款"></el-table-column>
          <el-table-column prop="salesman" label="提供发票"></el-table-column>
          <el-table-column prop="inTime" label="是否含税"></el-table-column>
          <el-table-column prop="manage" label="合同状态"></el-table-column>
           <el-table-column prop="salesman" label="审核人员"></el-table-column>
          <el-table-column prop="inTime" label="是否含税"></el-table-column>
          <el-table-column prop="manage" label="合同状态"></el-table-column>
        </el-table>
      </el-tab-pane>
