  ...
  <div class="allContent">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="费用记录" name="seventh">
        <el-table :data="afterSaleTableData" style="width: 100%">
          <el-table-column prop="isSolve" label="收支日期"></el-table-column>
          <el-table-column prop="feedbackTheme" label="收支类型"></el-table-column>
          <el-table-column prop="contact" label="费用类型"></el-table-column>
          <el-table-column prop="feedbackDate" label="总金额"></el-table-column>
          <el-table-column prop="detail" label="详情备注"></el-table-column>
          <el-table-column prop="outcome" label="业务员"></el-table-column>
          <el-table-column prop="manage" label="录入时间"></el-table-column>
          <el-table-column prop="manage" label="管理"></el-table-column>
        </el-table>
      </el-tab-pane>
