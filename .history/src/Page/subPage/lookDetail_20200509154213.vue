  ...
  <div class="allContent">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="附件记录" name="eighth">
        <el-table :data="afterSaleTableData" style="width: 100%">
          <el-table-column prop="paymentDate" label="编号"></el-table-column>
          <el-table-column prop="paymentType" label="附件类型"></el-table-column>
          <el-table-column prop="feeType" label="文件大小"></el-table-column>
          <el-table-column prop="amount" label="下载地址"></el-table-column>
          <el-table-column prop="detail" label="详情备注"></el-table-column>
          <el-table-column prop="people" label="业务员"></el-table-column>
